...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `6283141953754@s.whatsapp.net`]
...
costum(buffer, sticker, Verived, `©Specstor`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `©Specstor`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
zeroyt7.updatePresence(from, Presence.recording)
if (!isQuotedVideo) return reply('Reply Video nya Woi')
reply(mess.wait)
encmedia = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
media = await zeroyt7.downloadAndSaveMediaMessage(encmedia, './database/media_user')
ran = getRandom('.mp4')
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Nih Ngab'})
fs.unlinkSync(ran)
})
break
...
case 'play':
if (args.length == 0) return await reply(`Judul Lagunya Mana Woi\nContoh : ${prefix + command} melukis senja`)
...
break
case 'ytsearch':
if (args.length == 0) return reply(`Judul Video Yg Mau Di Cari Woi\nContoh : ${prefix + command} Melukis Senja`)
query = args.join(" ")
...
break
case 'ytmp4':
if (args.length == 0) return reply(`Link Nya Mana Woi\nContoh: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
ini_link = args[0]
...
await zeroyt7.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Nih Ngab'})
break
case 'tiktok':
if (args.length == 0) return reply(`Link Nya Mana Woi\nContoh: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
ini_url = args[0]
...
await zeroyt7.sendMessage(from, ini_buffer, video, { quoted: ftrol, caption: 'Nih Ngab'})
break
case 'tiktokmusic':
...
await zeroyt7.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'Nih Ngab'})
break
...
case 'kbbi':
if (args.length == 0) return reply(`Nama Yg Mau Dicari Mana Woi\nContoh: ${prefix + command} kursi`)
...
break
case 'jarak':
if (args.length == 0) return reply(`Nama Kotanya Mana Woi\nContoh: ${prefix + command} jakarta - yogyakarta`)
pauls = args.join(" ")
...
break
case 'wikipedia':
if (args.length == 0) return reply(`Nama Yg Mau Di Cari Mana Woi\nContoh: ${prefix + command} Tahu`)
query = args.join(" ")
...
break
case 'translate':
if (args.length == 0) return reply(`Teks Yg Mau Di Translate Mana Woi\nContoh: ${prefix + command} en Tahu Bacem`)
kode_negara = args[0]
args.shift()
ini_txt = args.join(" ")
...
break
case 'jadwaltv':
if (args.length == 0) return reply(`Nama Channel Nya Mana Woi\nContoh: ${prefix + command} SCTV`)
channel = args[0]
...
break
case 'playstore':
if (args.length == 0) return reply(`Nama Aplikasinya Mana Woi\nContoh: ${prefix + command} tiktok`)
query = args.join(" ")
...
break
case 'shopee':
if (args.length == 0) return reply(`Nama Barang Yg Mau Di Cari Mana Woi\nContoh: ${prefix + command} sepatu`)
query = args.join(" ")
...
break
case 'google':
if (args.length == 0) return reply(`Nama Yg Mau Cari Mana Woi\nContoh: ${prefix + command} sandrinna`)
query = args.join(" ")
...
case 'artinama':
if (args.length == 0) return reply(`Namanya Mana Woi\nContoh: ${prefix + command} Specstor`)
ini_nama = args.join(" ")
...
break
case 'jadian':
if (args.length == 0) return reply(`Tanggal Jadiannya Mana Woi\nContoh: ${prefix + command} 12 12 2020`)
tanggal = args[0]
bulan = args[1]
tahun = args[2]
...
case 'stalkig':
if (args.length == 0) return reply(`Usernamenya Mana Woi\nContoh: ${prefix + command} Sandrinna_11`)
username = args[0]
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih Ngab'})
})
break
...
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Ngab'})
break
case 'asupanhijaber':
...
zeroyt7.sendMessage(from, goo, image, {quoted: ftrol, caption: 'Nih Ngab'})
break
case 'cecanmalaysia':
...
case 'sc':
hayo = `
Sc Bot : https://github.com/specstro/specstorbot
...
zeroyt7.sendMessage(`6283141953754@s.whatsapp.net`, options, text, { quoted: ftrol })
